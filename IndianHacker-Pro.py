"""
    ...
    Script : IndianHacker - All in One Android Hacking ADB Toolkit  

    Copyright (C) 2023  Hackerindia (github.com/Hackerindia)
    ...
    original developer, [Hackerindia (github.com/Hackerindia)], and copying the code
    is not permitted without permission.

    For any queries, Contact me at : hackerindia3331@gmail.com
"""
...
def exit_phonesploit_pro():
    global run_IndianHacker_pro
    run_IndianHacker_pro = False
    print("\nExiting...\n")
...
def copy_whatsapp():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving data to IndianHacker-pro/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_sms():
    ...
    if pull_location == "":
        ...
        print(f"\n{color.PURPLE}Saving SMS file to IndianHacker-pro {pull_location}\n{color.WHITE}")
...
def dump_contacts():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Contacts file to IndianHacker-Pro/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_call_logs():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Call Logs file to IndianHacker-Pro/{pull_location}\n{color.WHITE}"
        )
    else:
        print(
...
def extract_apk():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving APK file to IndianHacker-Pro/{pull_location}\n{color.WHITE}"
        )
    else:
...
def update_me():
    print(f"{color.YELLOW}\nUpdating IndianHacker-Pro\n{color.WHITE}")
    print(f"{color.GREEN}Fetching latest updates from GitHub\n{color.WHITE}")
    os.system("git fetch")
    print(f"{color.GREEN}\nApplying changes\n{color.WHITE}")
    os.system("git rebase")
    print(f"{color.CYAN}\nPlease restart IndianHacker-Pro{color.WHITE}")
    exit_phonesploit_pro()


def visit_me():
    os.system(f"{opener} https://github.com/Hackerindia3331/IndianHacker-pro.git")
    print("\n")
...
def record_audio(mode):
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving recordings to ImdianHacker-pro/{pull_location}\n{color.WHITE}"
        )
    else:
...
"""
Copyright © 2024 Hackerindia (github.com/Hackerindia)
"""
